...
function Dashboard() {
    ...
    async function entrarTurma(e) {
        e.preventDefault();
        try {
            await api.post('/turmas/entrar', { codigo: codigoTurma });
        ...
        <Layout>
            ...
            <div style={{ padding: '24px' }}>
                <p style={{ fontSize: '13px', color: 'var(--gray-500)', marginBottom: '20px' }}>
                    Olá, {user?.nome}! Você está matriculado em {turmas.length} turma{turmas.length !== 1 ? 's' : ''}.
                </p>
                    ...
                    <div style={{
                        ...
                        {turmas.map((turma, i) => (
                            ...
                            >
                                ...
                                <div style={{ fontSize: '12px', color: 'var(--gray-400)', marginTop: '3px' }}>
                                        Prof. {turma.nome_professor || 'Professor não informado'}
                                </div>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <h2 style={{
                            ...
                            marginBottom: '20px',
                        }}>Entrar em nova turma</h2>
                        <form onSubmit={entrarTurma}>
                            <div style={{ marginBottom: '14px' }}>
                                <label style={labelStyle}>Código da turma</label>
                                <input
                                    type="text"
